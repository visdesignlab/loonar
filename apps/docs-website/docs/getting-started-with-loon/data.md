...
> In **Loon**, some formatting is handled automatically for you.  
> If you use [**Local Loon**](./index.md), you will have to format your data more manually.
...
>     - Cell [**Segmentations**](#segmentations-folder) as a folder of (boundaries outlining each cell) as `GeoJSON` files
>     - Cell **Metadata** as a `.csv` file, containing the cell's `id`, `mass`, `x`, `y` etc. over `time`
> 
> 
